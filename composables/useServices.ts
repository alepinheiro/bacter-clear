export function useServices () {
    const services = [{
        ...
        ' Por fim, o controle de pombos e morcegos no perímetro urbano também protege esses animais. Eles podem sofrer com a falta de alimentos e abrigo em ambientes urbanos, o que pode afetar sua saúde e bem-estar. A remoção de pombos e morcegos deve ser realizada de forma humanitária, de acordo com as leis e regulamentações. <br><br>' +
