        ...
        <section class="block w-full shadow-lg">
            <div class="relative h-full">
                <div class=" flex-1 z-0">
                    <ClientOnly>
                        <Swiper :slides-per-view="1" :centered-slides="true" :auto-height="false" :autoplay="true"
                            :modules="[Autoplay]">
                            <SwiperSlide>
                                <img src='https://mediad.publicbroadcasting.net/p/kuow/files/styles/x_large/public/201511/IMG_0669_0.JPG'
                                    width="600" height="400" class="w-full object-cover h-96" alt='' />
                            </SwiperSlide>
                            <SwiperSlide>
                                <img src='https://mediad.publicbroadcasting.net/p/kuow/files/styles/x_large/public/201511/IMG_0669_0.JPG'
                                    width="600" height="400" class="w-full object-cover h-96" alt='' />
                ...
                <div class="w-full max-w-4xl" id="cards">
                    <ClientOnly>
                        ...
                        :breakpoints="{
                            ...
                            :auto-play="true" :modules="[Autoplay, Pagination]" :pagination="{
                              clickable: true,
                            } as any">
        ...
        <section class="max-w-4xl mx-auto py-10 px-5">
            <div class="flex md:flex-row flex-col w-full gap-10 justify-center items-center">
                <div class="flex flex-col gap-4 text-center flex-1">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Semper felis, eu est turpis tortor quis mauris. Bibendum enim molestie nulla netus tellus. Pharetra turpis adipiscing sapien habitant. Justo, commodo amet cursus tristique et vitae vitae cursus.</p>
                </div>
